...
if (isset($_POST["save"])) {
    ...
    //SELECT count(1) as 'exists' FROM User where email = :email or username = :user
    $db = getDB();
...
<form method="POST" onsubmit="return validate(this);">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="fname" id="fname" value="<?php se($fname); ?>" />
    </div>
    <div class="mb-3">
        <label for="lname">Last Name</label>
        <input type="text" name="lname" id="lname" value="<?php se($lname); ?>" />
    </div>
    ...
    <label for="cp">Account Status</label>
