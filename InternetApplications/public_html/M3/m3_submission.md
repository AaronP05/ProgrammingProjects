...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/84828015/161083653-558cd745-555f-4408-a563-9f9ccdfae669.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Register changes color when you click on it as well when you use<br>mouse over. You can see the url change as well<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 4: </em> Screenshot showing after the profile link is clicked (be sure to include the url)</td></tr>
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/84828015/161083940-01cc2330-872f-4131-a618-49b43c872303.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Profile changes color when you click on it as well when you use<br>mouse over. You can see the url change as well<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 5: </em> Screenshot showing after the logout link is clicked (be sure to include the url)</td></tr>
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/84828015/161084240-a53856e3-1267-4701-aa89-d95a963f001b.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Logout changes color when you click on it as well when you use<br>mouse over. You can see the url change as well<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>I used the display:inline function to make the navigation horizontal<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Briefly explain how you remove the navigation list item markers</td></tr>
<tr><td> <em>Response:</em> <p>I inserted the checkmarks using list-style-type function<br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Briefly explain how you gave the navigation a background</td></tr>
<tr><td> <em>Response:</em> <p>I used the body background color function to change the background<br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>I used the hover function to change the color on mouseover<br></p><br></td></tr>
<tr><td> <em>Sub-Task 5: </em> Briefly explain how you changed the challenge list bullet points to checkmarks (✓)</td></tr>
<tr><td> <em>Response:</em> <p>I added the checkmarks by removing the list markers and adding content <br></p><br></td></tr>
<tr><td> <em>Sub-Task 6: </em> Briefly explain how you made the first character of the h1 tags and anchor tags uppercased</td></tr>
<tr><td> <em>Response:</em> <p>I used in text transform function to change the first character<br></p><br></td></tr>
<tr><td> <em>Sub-Task 7: </em> Briefly explain/describe your custom styling of your choice</td></tr>
<tr><td> <em>Response:</em> <p>My styling is pretty simple. I added a background color and change the<br>text color as well<br></p><br></td></tr>
<tr><td> <em>Sub-Task 8: </em> Briefly explain how the styling for the challenge list doesn't impact the navigation list</td></tr>
<tr><td> <em>Response:</em> <p>It does not impact the navigation list because it has different text color<br>and also it is not a link<br></p><br></td></tr>
<tr><td> <em>Sub-Task 9: </em> Briefly explain how you updated the content of the h1 tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>I got rid of the start tag<br></p><br></td></tr>
<tr><td> <em>Sub-Task 10: </em> Briefly explain how you updated the content of the title tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>I put all the changes inside the style tag <br></p><br></td></tr>
</table></td></tr>
